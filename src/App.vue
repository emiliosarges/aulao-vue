...
import DataBinding from './components/DataBindind.vue';
import ComProps from './components/ComProps.vue';
import EscutaEvento from './components/EscutaEvento.vue';
import PropriedadeComputadas from './components/PropriedadeComputadas.vue';
...
<template>
  ...
  <RenderizacaoCondicional nome="Maria" :qtdeCachorros="3"/>
  <PropriedadesAssistidas/>
  <PropriedadeComputadas/>
  <EscutaEvento/>
  <ComProps item="Apontador" :preco="1.99"/>
  <ComProps item="Caderno" v-bind:preco="10.25"/>
